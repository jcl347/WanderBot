...
function buildCityTerms(dest: any, limit = 24) {
  ...
  const model: string[] = Array.isArray(analysis.vacation_image_queries)
    ? analysis.vacation_image_queries
    : Array.isArray(analysis.image_queries)
...
export default function DestDetailClient({ dest }: { dest: any }) {
  ...
  return (
    <LiveCollage
      ...
      railWidth={240}                               // narrower rails
      className="mx-auto max-w-[1900px] px-4 md:px-8" // much wider center
