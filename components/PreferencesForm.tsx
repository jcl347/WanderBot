...
type Traveler = {
  ...
  name: string;
  relationship?: string;
  homeLocation: string; // e.g., LAX or "Los Angeles, CA"
  age?: string;
  gender?: string;
  personality?: string; // e.g., "dislikes travel", "loves beaches"
  isUser?: boolean;
  spouse?: string;       // spouse name if applicable
  kids?: string;         // number of kids, as string so inputs are easy
};
